...
def split_metadata(train_records: Sequence[SelectorRecord], val_records: Sequence[SelectorRecord]) -> Dict[str, object]:
...
def main() -> None:
    ...
    target_stats.update(split_metadata(train_records, val_records))
